...
def evalandprint(args, algclass, train_loaders, val_loaders, test_loaders, SAVE_PATH, best_acc, best_tacc, a_iter, best_changed):
    ...
    for client_idx in range(args.n_clients):
        train_loss, train_acc, train_precision, train_recall, train_f1 = algclass.client_eval(
    ...
    for client_idx in range(args.n_clients):
        val_loss, val_acc, val_precision, val_recall, val_f1 = algclass.client_eval(
    ...
    if best_changed:
        ...
        # test
        for client_idx in range(args.n_clients):
            _, test_acc, test_precision, test_recall, test_f1 = algclass.client_eval(
